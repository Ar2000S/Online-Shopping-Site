...
// Carries only the fields a client may legitimately submit when registering a new member.
// Deliberately excludes memberNo, deleteFlag, regDate, lastUpd. Cuz those are server-assigned.
